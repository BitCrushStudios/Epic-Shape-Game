...
class_name ItemExtraBigCubeUpgradeResource

func _init():
	super()
	name = "Big Cube"
	description = "Spawns one big cube"
	texture = preload("res://Assets/Art/Items/Cube Icon.png")
	base_price = 100
func apply(gameMain:GameMain):
	gameMain.weaponsManager.add_weapon(preload("res://Game/Weapons/big_cube.tscn").instantiate())
